<template>
   <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <circle style="fill:#fb8c38;" cx="48" cy="5" r="5"/>
    <circle style="fill:#ff6384;" cx="28" cy="48" r="5"/>
    <circle style="fill:#00bf26;" cx="5" cy="46" r="5"/>
    <circle style="fill:#ff643d;" cx="12" cy="8" r="3"/>
    <circle style="fill:#fbb000;" cx="44" cy="40" r="3"/>
    <circle style="fill:#6391ff;" cx="28" cy="24" r="7"/>
  </svg>
</template>